...
// wis-core-result-envelope-v0-1-draft.validator.js
var validateWisCoreResultEnvelopeV01Structure = validate69;
var schema101 = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'https://schemas.workspai.dev/wis/core/result-envelope/0.1.0-draft',
  title: 'WisCoreResultEnvelopeV01',
  description: 'Frozen previous-major compatibility contract for the WIS Core result envelope.',
  type: 'object',
  ...
  properties: {
    specVersion: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier',
    },
    coreVersion: { const: '0.1.0-draft' },
    schemaId: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier',
    },
    profile: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/ProfileReference',
    },
    artifactId: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier',
    },
    producer: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/ProducerReference',
    },
    operation: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier',
    },
    scope: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/ScopeReference',
    },
    generation: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/GenerationReference',
    },
    outcome: { enum: ['pass', 'attention', 'blocked', 'partial', 'failed'] },
    payload: true,
    evidence: {
      type: 'array',
      maxItems: 1e4,
      items: {
        $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/EvidenceReference',
      },
    },
    freshness: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/FreshnessSummary',
    },
    unknowns: {
      type: 'array',
      maxItems: 1e3,
      items: {
        $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/UnknownRecord',
      },
    },
    omissions: {
      type: 'array',
      maxItems: 1e3,
      items: {
        $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/OmissionRecord',
      },
    },
    diagnostics: {
      type: 'array',
      maxItems: 1e3,
      items: {
        $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/Diagnostic',
      },
    },
    extensions: {
      $ref: 'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/Extensions',
    },
  },
};
    ...
    if (data && typeof data == 'object' && !Array.isArray(data)) {
      ...
      if (
        ...
        ((data.generation === void 0 || !func0.call(data, 'generation')) &&
          (missing0 = 'generation')) ||
        ((data.outcome === void 0 || !func0.call(data, 'outcome')) && (missing0 = 'outcome')) ||
        ...
        const _errs1 = errors;
        for (const key0 of Object.keys(data)) {
          if (!func0.call(schema101.properties, key0)) {
            validate69.errors = [
              {
                instancePath,
                schemaPath: '#/additionalProperties',
                  ...
                  validate69.errors = [
                    {
                      ...
                      schemaPath:
                        'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier/maxLength',
                      keyword: 'maxLength',
                      params: { limit: 512 },
                      message: 'must NOT have more than 512 characters',
                    },
                    ...
                    validate69.errors = [
                      {
                        instancePath: instancePath + '/specVersion',
                        schemaPath:
                          'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier/minLength',
                        keyword: 'minLength',
                        params: { limit: 1 },
                        message: 'must NOT have fewer than 1 characters',
                      },
                ...
                validate69.errors = [
                  {
                    instancePath: instancePath + '/specVersion',
                    schemaPath:
                      'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/NonEmptyIdentifier/type',
                    keyword: 'type',
                    params: { type: 'string' },
                    message: 'must be string',
                  },
                  ...
                  if (valid0) {
                    if (data.producer !== void 0 && func0.call(data, 'producer')) {
                      ...
                      if (
                        ...
                        vErrors =
                          vErrors === null ? validate72.errors : vErrors.concat(validate72.errors);
                        errors = vErrors.length;
                      }
                      var valid0 = _errs13 === errors;
                    } else {
                    ...
                    if (valid0) {
                      ...
                      if (valid0) {
                        ...
                        if (valid0) {
                          ...
                          if (valid0) {
                            if (data.outcome !== void 0 && func0.call(data, 'outcome')) {
                                ...
                                validate69.errors = [
                                  {
                                    ...
                                    schemaPath: '#/properties/outcome/enum',
                                    keyword: 'enum',
                                    params: { allowedValues: schema101.properties.outcome.enum },
                                    message: 'must be equal to one of the allowed values',
                                  },
                                ];
                                return false;
                                ...
                                if (valid0) {
                                  ...
                                  if (valid0) {
                                    if (
                                      ...
                                      let data15 = data.omissions;
                                      const _errs27 = errors;
                                      if (errors === _errs27) {
                                        if (Array.isArray(data15)) {
                                          if (data15.length > 1e3) {
                                            validate69.errors = [
                                              {
                                        ...
                                        if (
                                          ...
                                          if (errors === _errs34) {
                                            if (
                                              ...
                                              if (Object.keys(data19).length > 32) {
                                                validate69.errors = [
                                                  {
                                                    instancePath: instancePath + '/extensions',
                                                    schemaPath:
                                                      'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/Extensions/maxProperties',
                                                ...
                                                for (const key1 of Object.keys(data19)) {
                                                  ...
                                                  if (typeof key1 === 'string') {
                                                    if (!pattern16.test(key1)) {
                                                      const err0 = {
                                                        instancePath: instancePath + '/extensions',
                                                        schemaPath:
                                                          'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/Extensions/propertyNames/pattern',
                                                        keyword: 'pattern',
                                                        params: {
                                                          pattern:
                                                            '^[a-z][a-z0-9]*(?:[.-][a-z0-9]+)+$',
                                                  ...
                                                  if (!valid10) {
                                                    const err1 = {
                                                      instancePath: instancePath + '/extensions',
                                                      schemaPath:
                                                        'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/Extensions/propertyNames',
                                              ...
                                              validate69.errors = [
                                                {
                                                  instancePath: instancePath + '/extensions',
                                                  schemaPath:
                                                    'https://schemas.workspai.dev/wis/core/result-envelope/0.2.0-draft#/$defs/Extensions/type',
                                                  keyword: 'type',
                                                  params: { type: 'object' },
                                                  message: 'must be object',
                                                },
...
export { validateWisCoreResultEnvelopeV01Structure };
