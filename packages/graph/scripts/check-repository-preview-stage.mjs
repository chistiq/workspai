...
const implementationPaths = [
  ...
  'packages/graph/src/providers/codeowners.ts',
  'packages/graph/src/providers/compose-topology.ts',
  'packages/graph/src/providers/build-topology.ts',
  'packages/graph/src/providers/protobuf-topology.ts',
  'packages/graph/src/providers/source-entrypoints.ts',
  ...
  'packages/graph/test/build/system-topology-providers.test.ts',
  'packages/graph/test/providers/declaration-parsers.test.ts',
