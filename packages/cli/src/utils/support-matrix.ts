...
export const RUNTIME_SUPPORT_MATRIX: Record<string, RuntimeSupportMatrixEntry> = {
  python: {
    ...
    moduleCommands: true,
    doctorSupport: 'full',
    notes: ['Core-backed Python projects support RapidKit Core modules and lifecycle commands.'],
  },
  node: {
    runtime: 'node',
    displayName: 'Node.js',
  ...
  php: {
    ...
    doctorSupport: 'readiness',
    notes: [
      'Laravel projects use the official Composer generator and PHP/Composer lifecycle adapter.',
    ],
  },
  ruby: {
    runtime: 'ruby',
  ...
  rust: {
    ...
    moduleCommands: false,
    doctorSupport: 'readiness',
    notes: ['Rust projects support Axum and Tauri scaffolding plus Cargo lifecycle commands.'],
  },
  elixir: {
    runtime: 'elixir',
    displayName: 'Elixir',
