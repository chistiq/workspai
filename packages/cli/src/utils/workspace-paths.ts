...
export const PROJECT_KNOWLEDGE_GRAPH_REFERENCE_FILE = 'project-knowledge-graph-reference.json';
...
export const PROJECT_KNOWLEDGE_GRAPH_REFERENCE_RELATIVE_PATH = `${WORKSPAI_METADATA_DIR}/reports/${PROJECT_KNOWLEDGE_GRAPH_REFERENCE_FILE}`;
