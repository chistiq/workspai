...
# Workspai ${options.runtimeLabel} project launcher — generated by Workspai CLI
# https://workspai.dev
...
case "$CMD" in
    ...
    docs)
        ...
        ;;
	    help|--help|-h)
	        echo "Workspai — ${options.runtimeLabel} project: ${options.projectName}"
	        echo ""
...
export function buildGoLauncherCmdTemplate(
  ...
  return `@echo off
setlocal
rem Workspai ${options.runtimeLabel} project launcher — Windows
set CMD=%1
if "%CMD%"=="" goto usage
shift
...
:usage
echo Workspai ${options.runtimeLabel} project launcher
echo.
