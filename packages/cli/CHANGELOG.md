...
- Stabilize Windows adoption integration cleanup by releasing test doubles before
  bounded retries for transient filesystem locks; persistent locks still fail.
