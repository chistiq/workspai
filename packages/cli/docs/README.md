...
| [agent-framework-adapters.md](./agent-framework-adapters.md)                                   | Framework-neutral kit/attach contract, security boundaries, capability truth, and conformance admission             |
