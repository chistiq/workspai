...
| Design a proof-carrying architecture change        | [Proof-Carrying Change](./proof-carrying-change.md)                                         | Candidate lease, prediction, actual delta, verification and capsule plan |
...
| [proof-carrying-change.md](./proof-carrying-change.md)                                         | Architecture preparation for generation-pinned predicted-vs-actual change capsules; not yet a released command    |
